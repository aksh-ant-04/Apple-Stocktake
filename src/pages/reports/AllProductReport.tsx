...
const AllProductReport: React.FC = () => {
  ...
  // Generate report data - NOTE: Parameters swapped to match new logic
  const allData = useMemo(() => {
    return generateAllProductReport(scanData, itemMaster, tagMaster);
  }, [scanData, itemMaster, tagMaster]);
  ...
  // Table columns definition - Updated to include SHELF column
  const columns = [
    { header: 'TAG DESCRIPTION', accessor: 'TAG_AREA_DESCRIPTION' },
    ...
    { header: 'VERIFIED QTY', accessor: 'VERIFIED_QUANTITY' },
    { header: 'REMARKS', accessor: 'REMARKS' },
  ];

  return (
    <div className="max-w-full mx-auto">
      <ReportHeader title="ALL PRODUCT REPORT" />
      ...
      <motion.div className="mb-6 space-y-4">
        ...
        <div className="flex justify-end">
          <DownloadButtons
            ...
            columns={columns}
            reportTitle="All_Product_Report"
          />
        </div>
      </motion.div>
